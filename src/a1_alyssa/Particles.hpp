...
class Particles
{
    ...
    public:
        ...
        LaserScanRange getLaserScan(maebot_pose_t poseA, maebot_laser_scan_t scanB, std::vector<maebot_pose_t>& poses, maebot_pose_t *mB);
        bool findLeftRightPoses(int64_t time, std::vector<maebot_pose_t>& poses, maebot_pose_t* m);
};
